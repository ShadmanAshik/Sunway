      ...
      <section>
        ...
        <span className="top-sec">
          <div className="text1">
            <h1>Why Join Us?</h1>
            <p>
              Digi Edu Pro friendly agent platform. Our
            ...
            <p>
              ...
              personnel. Digi Edu Pro will provide full length supports
              documentation to registration in university after visa. Strength
